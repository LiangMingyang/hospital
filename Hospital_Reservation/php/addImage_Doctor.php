...
$filename="doctor_pic_".date('YmdHis').".".$filetype;
$storage_url="http://localhost/Hospital_Reservation//doctor_image//";
$storage_path="../doctor_image//";
if(trim($oldfile)!=''){
...
if($error_code!='0'){
	...
	$res['Doctor_Picture_url']=$storage_url;
}else{
	$res["msg"] = -1;
    $res["error"] = "Upload Fail";
	$res['filename']="";
	$res['Doctor_Picture_url']="";
}
