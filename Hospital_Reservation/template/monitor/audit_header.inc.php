...
<title>数据库审计系统</title>
<link
	href="<?php echo CSS_PATH?>main<?php echo $css?>.css?<?php echo mktime();?>"
	rel="stylesheet" type="text/css" />
<link href="<?php echo CSS_PATH?>jquery/jquery.ui.all.css?>"
	rel="stylesheet" type="text/css" />
...
<script type="text/javascript"
	src="<?php echo JS_PATH?>dia.js?<?php echo mktime();?>"></script>

<!-- flexgrid -->
<link href="<?php echo CSS_PATH?>flexigrid/flexigrid.css?>" rel="stylesheet"
	type="text/css" />
<link href="<?php echo CSS_PATH?>flexigrid_define.css?>" rel="stylesheet"
	type="text/css" />
<script type="text/javascript" src="<?php echo JS_PATH?>flexigrid/flexigrid.js?"></script>
<!-- 审计事件模块的js -->
<script type="text/javascript"
	src="<?php echo JS_PATH?>monitor/audit.js?"></script>
<script type="text/javascript"
	src="<?php echo JS_PATH?>monitor/audit_nondb.js?"></script>
