...
<script type="text/javascript" src="<?php echo JS_PATH?>dia.js?<?php echo mktime();?>"></script>
<script type="text/javascript" src="<?php echo JS_PATH?>policy/policy.js?"></script>
