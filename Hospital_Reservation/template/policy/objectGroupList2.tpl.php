         ...
         <div class="tabContent">
     	 	...
     	 	<table  border="0" cellspacing="0" cellpadding="0" width="100%" class="tab4">
             	<tbody>
                    ...
                    ?>          
                    <tr>
                    	<td><?php echo $group['ObjectGroupID']?></td>
     	 	 ...
     	 	 <table  border="0" cellspacing="0" cellpadding="0" width="100%" class="tab4">
             	<tbody>
                    ...
                    <tr>
						...
						<td><a href="#" class="neibu" style="color: white;" onclick="deleteObject(<?php echo $obj['ObjectID']?>);">删除</a></td>
                    </tr>       
                    <?php }?>   
                </tbody>
             </table> 
     ...
     <div id="addObjectGroupForm" title="添加对象组" style="display: none;">
		<form action="">
			<table id="objectGroupGrid" style="color: orange; left: 1px;" class="tab4">
				<tr>
					<td>对象组名称：</td>
					<td><input type="text" name="newGroupName" id="newGroupName" value="" style="width: 250px;"/></td>
				</tr>
				<tr>
					<td>选择服务名：</td>
					<td>
