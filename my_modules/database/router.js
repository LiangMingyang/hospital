...
router.post('/Find_Doctor_Time', dbhelper.Find_Doctor_Time);
...
router.post('/Get_Password_Admin', dbhelper.Get_Password_Admin);

router.post('/Get_Password_User', dbhelper.Get_Password_User);
